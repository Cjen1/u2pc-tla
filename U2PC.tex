...
\begin{document}
\tlatex
\fl{}\moduleLeftDash\cl{ {\MODULE} U2PC}\moduleRightDash\cl{}
\fl{ {\EXTENDS} FiniteSets ,\, Integers ,\, Apalache ,\, TLC}
\fl{}
\fl{}
\fl{}
\fl{}
...
\fl{ Txns}
\fl{}
 \fl{ {\ASSUME} \A\, k1 ,\, k2 \.{\in} {\DOMAIN} Shards \.{:} k1 \.{\neq} k2
...
\fl{ Replicas ,\,}
\fl{}
\fl{ Coordinator\_state ,\,}
\fl{}
\fl{ Coordinator\_txn\_state ,\,}
\fl{}
\fl{ M\_read ,\,}
\fl{}
\fl{ M\_read\_resp ,\,}
...
\fl{ M\_unlock\_resp}
\fl{}
 \fl{ Msgs \.{\defeq} {\langle} M\_read ,\, M\_read\_resp ,\, M\_lock ,\,
 M\_lock\_resp ,\, M\_unlock ,\, M\_unlock\_resp {\rangle}}
\fl{}
\fl{}
\fl{ Range ( F ) \.{\defeq} \{ F [ x ] \.{:} x \.{\in} {\DOMAIN} F \}}
\fl{}
\fl{}
\fl{ RIDs}\al{53}{1}{ \.{\defeq}}\al{53}{2}{ {\UNION} Range ( Shards )}
\fl{ TIDs}\al{54}{1}{ \.{\defeq}}\al{54}{2}{ {\DOMAIN} Txns}
\fl{}
 \fl{ KeyLookup \.{\defeq} [ r \.{\in} RIDs \.{\mapsto} {\CHOOSE} k \.{\in}
 {\DOMAIN} Shards \.{:} r \.{\in} Shards [ k ] ]}
\fl{}
\fl{ Init}\al{58}{1}{ \.{\defeq}}
 \fl{ \.{\land}}\al{59}{1}{ Replicas \.{=} [ r \.{\in} RIDs \.{\mapsto} [
 locked \.{\mapsto} {\FALSE} ,\, version \.{\mapsto}\@w{Init} ,\, logged
 \.{\mapsto}\@w{NULL} ] ]}
 \fl{ \.{\land}}\al{60}{1}{ Coordinator\_state \.{=} [ t \.{\in} TIDs
 \.{\mapsto}\@w{Start} ]}
 \fl{ \.{\land}}\al{61}{1}{ Coordinator\_txn\_state \.{=} [ t}\al{61}{5}{
 \.{\in} TIDs \.{\mapsto} SetAsFun ( \{ \} ) ]}
 \fl{ \.{\land}}\al{62}{1}{ M\_read}\al{62}{2}{ \.{=}}\al{62}{3}{ \{
 \}}\al{62}{5}{ \.{\land}}\al{62}{6}{ M\_read\_resp}\al{62}{7}{ \.{=} \{ \}}
 \fl{ \.{\land}}\al{63}{1}{ M\_lock}\al{63}{2}{ \.{=}}\al{63}{3}{ \{
 \}}\al{63}{5}{ \.{\land}}\al{63}{6}{ M\_lock\_resp}\al{63}{7}{ \.{=} \{ \}}
 \fl{ \.{\land}}\al{64}{1}{ M\_unlock \.{=} \{ \} \.{\land} M\_unlock\_resp
 \.{=} \{ \}}
\fl{}
 \fl{ RelevantReplicas ( t )}\al{66}{4}{ \.{\defeq} {\UNION} \{ Shards [ k ]
 \.{:} k \.{\in} Txns [ t ] \}}
\fl{}
\fl{ CoordinatorStart ( t )}\al{68}{4}{ \.{\defeq}}
\fl{ \.{\land}}\al{69}{1}{ Coordinator\_state [ t ] \.{=}\@w{Start}}
 \fl{ \.{\land}}\al{70}{1}{ M\_read \.{'} \.{=} M\_read \.{\cup} \{ [ src
 \.{\mapsto} t ,\, key \.{\mapsto} k ] \.{:} k \.{\in} Txns [ t ] \}}
 \fl{ \.{\land}}\al{71}{1}{ {\UNCHANGED} {\langle} M\_read\_resp ,\, M\_lock
 ,\, M\_lock\_resp ,\, M\_unlock ,\, M\_unlock\_resp {\rangle}}
 \fl{ \.{\land}}\al{72}{1}{ Coordinator\_state \.{'} \.{=} [
 Coordinator\_state {\EXCEPT} {\bang} [ t ] \.{=}\@w{Read} ]}
 \fl{ \.{\land}}\al{73}{1}{ {\UNCHANGED} {\langle} Coordinator\_txn\_state ,\,
 Replicas {\rangle}}
\fl{}
\fl{ ReplicaRead ( r ) \.{\defeq}}
\fl{ \.{\land}}\al{76}{1}{ Replicas [ r ] . locked \.{=} {\FALSE}}
\fl{ \.{\land}}\al{77}{1}{ \E\,}\al{77}{2}{ m \.{\in} M\_read \.{:}}
 \fl{ \.{\land}}\al{78}{1}{ {\lnot} \E\, m1 \.{\in} M\_read\_resp \.{:} m1 .
 src \.{=} r \.{\land} m1 . dst \.{=} m . src}
 \fl{ \.{\land}}\al{79}{1}{ M\_read\_resp \.{'} \.{=} M\_read\_resp \.{\cup}
 \{ [ src \.{\mapsto} r ,\, dst \.{\mapsto} m . src ,\, ver \.{\mapsto}
 Replicas [ r ] . version ] \}}
 \fl{ \.{\land}}\al{80}{1}{ {\UNCHANGED} {\langle} M\_read ,\, M\_lock ,\,
 M\_lock\_resp ,\, M\_unlock ,\, M\_unlock\_resp {\rangle}}
 \fl{ \.{\land}}\al{81}{1}{ {\UNCHANGED} {\langle} Replicas ,\,
 Coordinator\_state ,\, Coordinator\_txn\_state {\rangle}}
\fl{}
\fl{ CoordinatorRead ( t ) \.{\defeq}}
\fl{ \.{\land}}\al{84}{1}{ Coordinator\_state [ t ] \.{=}\@w{Read}}
 \fl{ \.{\land}}\al{85}{1}{ \A\, k}\al{85}{3}{ \.{\in}}\al{85}{4}{ Txns [ t ]
 \.{:} \E\, m \.{\in} M\_read\_resp \.{:} KeyLookup [ m . src ] \.{=} k}
 \fl{ \.{\land}}\al{86}{1}{ \E\,}\al{86}{2}{ F}\al{86}{3}{ \.{\in}}\al{86}{4}{
 [ Txns [ t ] \.{\rightarrow} RIDs ] \.{:}}
 \fl{ \.{\land}}\al{87}{1}{ \A\, k \.{\in} Txns [ t ] \.{:}}\al{87}{9}{
 \.{\land}}\al{87}{10}{ k \.{=} KeyLookup [ F [ k ] ]}
 \fl{ \.{\land}}\al{88}{1}{ \E\, m \.{\in} M\_read\_resp \.{:} m . dst \.{=} t
 \.{\land} m . src \.{=} F [ k ]}
 \fl{ \.{\land}}\al{89}{1}{ Coordinator\_txn\_state \.{'} \.{=} [
 Coordinator\_txn\_state {\EXCEPT} {\bang} [ t ] \.{=} [}
 \fl{ k \.{\in} Txns [ t ] \.{\mapsto} ( {\CHOOSE} m \.{\in} M\_read\_resp
 \.{:} m . dst \.{=} t \.{\land} m . src \.{=} F [ k ] ) . ver}
\fl{ ] ]}
 \fl{ \.{\land}}\al{92}{1}{ Coordinator\_state \.{'} \.{=} [
 Coordinator\_state {\EXCEPT} {\bang} [ t ] \.{=}\@w{Lock} ]}
\fl{ \.{\land}}\al{93}{1}{ {\UNCHANGED} {\langle} Replicas ,\, Msgs {\rangle}}
\fl{}
\fl{ CoordinatorLock ( t ) \.{\defeq}}
\fl{ \.{\land}}\al{96}{1}{ Coordinator\_state [ t ] \.{=}\@w{Lock}}
 \fl{ \.{\land}}\al{97}{1}{ M\_lock \.{'} \.{=} M\_lock \.{\cup} \{ [ tid
 \.{\mapsto} t ,\, txn \.{\mapsto} Txns [ t ] ,\, state \.{\mapsto}
 Coordinator\_txn\_state [ t ] ] \}}
 \fl{ \.{\land}}\al{98}{1}{ {\UNCHANGED} {\langle} M\_read ,\, M\_read\_resp
 ,\, M\_lock\_resp ,\, M\_unlock ,\, M\_unlock\_resp {\rangle}}
 \fl{ \.{\land}}\al{99}{1}{ Coordinator\_state \.{'} \.{=} [
 Coordinator\_state {\EXCEPT} {\bang} [ t ] \.{=}\@w{Decide} ]}
 \fl{ \.{\land}}\al{100}{1}{ {\UNCHANGED} {\langle} Coordinator\_txn\_state
 ,\, Replicas {\rangle}}
\fl{}
\fl{ ReplicaLock ( r ) \.{\defeq}}
\fl{ \.{\land}}\al{103}{1}{ \E\,}\al{103}{2}{ m \.{\in} M\_lock \.{:}}
\fl{ \.{\land}}\al{104}{1}{ KeyLookup [ r ] \.{\in} m . txn}
 \fl{ \.{\land}}\al{105}{1}{ {\lnot} \E\, m1 \.{\in} M\_lock\_resp \.{:} m1 .
 src \.{=} r \.{\land} m1 . dst \.{=} m . tid}
 \fl{ \.{\land}}\al{106}{1}{ {\IF} ( {\lnot} Replicas [ r ] . locked )
 \.{\land} Replicas [ r ] . version \.{=} m . state [ KeyLookup [ r ] ]}
\fl{ \.{\THEN}}
 \fl{ \.{\land}}\al{108}{1}{ Replicas \.{'} \.{=} [ Replicas {\EXCEPT} {\bang}
 [ r ] \.{=} [}
 \fl{ locked \.{\mapsto} {\TRUE} ,\, version \.{\mapsto} Replicas [ r ] .
 version ,\, logged \.{\mapsto} m . tid ] ]}
 \fl{ \.{\land}}\al{110}{1}{ M\_lock\_resp \.{'} \.{=} M\_lock\_resp \.{\cup}
 \{ [ src \.{\mapsto} r ,\, dst \.{\mapsto} m . tid ,\, locked \.{\mapsto}
 {\TRUE} ] \}}
\fl{ \.{\ELSE}}
 \fl{ \.{\land}}\al{112}{1}{ M\_lock\_resp \.{'} \.{=} M\_lock\_resp \.{\cup}
 \{ [ src \.{\mapsto} r ,\, dst \.{\mapsto} m . tid ,\, locked \.{\mapsto}
 {\FALSE} ] \}}
\fl{ \.{\land}}\al{113}{1}{ {\UNCHANGED} Replicas}
 \fl{ \.{\land}}\al{114}{1}{ {\UNCHANGED} {\langle} M\_read ,\, M\_read\_resp
 ,\, M\_lock ,\, M\_unlock ,\, M\_unlock\_resp {\rangle}}
 \fl{ \.{\land}}\al{115}{1}{ {\UNCHANGED} {\langle} Coordinator\_state ,\,
 Coordinator\_txn\_state {\rangle}}
\fl{}
\fl{ CoordinatorCommit ( t ) \.{\defeq}}
\fl{ \.{\land}}\al{118}{1}{ Coordinator\_state [ t ] \.{=}\@w{Decide}}
 \fl{ \.{\land}}\al{119}{1}{ \A\, k \.{\in} Txns [ t ] \.{:} \A\, r \.{\in}
 Shards [ k ] \.{:} \E\, m \.{\in} M\_lock\_resp \.{:}}
\fl{ \.{\land}}\al{120}{1}{ m . src \.{=} r \.{\land} m . dst \.{=} t}
\fl{ \.{\land}}\al{121}{1}{ m . locked}
 \fl{ \.{\land}}\al{122}{1}{ Coordinator\_state \.{'} \.{=} [
 Coordinator\_state {\EXCEPT} {\bang} [ t ] \.{=}\@w{Commit} ]}
 \fl{ \.{\land}}\al{123}{1}{ M\_unlock \.{'} \.{=} M\_unlock \.{\cup} \{ [ src
 \.{\mapsto} t ,\, apply \.{\mapsto} {\TRUE} ] \}}
 \fl{ \.{\land}}\al{124}{1}{ {\UNCHANGED} {\langle} M\_read ,\, M\_read\_resp
 ,\, M\_lock ,\, M\_lock\_resp ,\, M\_unlock\_resp {\rangle}}
 \fl{ \.{\land}}\al{125}{1}{ {\UNCHANGED} {\langle} Replicas ,\,
 Coordinator\_txn\_state {\rangle}}
\fl{}
\fl{ CoordinatorStartAbort ( t ) \.{\defeq}}
\fl{ \.{\land}}\al{128}{1}{ Coordinator\_state [ t ] \.{=}\@w{Decide}}
 \fl{ \.{\land}}\al{129}{1}{ \E\, k \.{\in} Txns [ t ] \.{:} \E\, r \.{\in}
 Shards [ k ] \.{:} \E\, m \.{\in} M\_lock\_resp \.{:}}
\fl{ \.{\land}}\al{130}{1}{ m . src \.{=} r \.{\land} m . dst \.{=} t}
\fl{ \.{\land}}\al{131}{1}{ {\lnot} m . locked}
 \fl{ \.{\land}}\al{132}{1}{ Coordinator\_state \.{'} \.{=} [
 Coordinator\_state {\EXCEPT} {\bang} [ t ] \.{=}\@w{TryAbort} ]}
 \fl{ \.{\land}}\al{133}{1}{ M\_unlock \.{'} \.{=} M\_unlock \.{\cup} \{ [ src
 \.{\mapsto} t ,\, apply \.{\mapsto} {\FALSE} ] \}}
 \fl{ \.{\land}}\al{134}{1}{ {\UNCHANGED} {\langle} M\_read ,\, M\_read\_resp
 ,\, M\_lock ,\, M\_lock\_resp ,\, M\_unlock\_resp {\rangle}}
 \fl{ \.{\land}}\al{135}{1}{ {\UNCHANGED} {\langle} Replicas ,\,
 Coordinator\_txn\_state {\rangle}}
\fl{}
\fl{ ReplicaUnlock ( r ) \.{\defeq}}
\fl{ \E\,}\al{138}{1}{ m \.{\in} M\_unlock \.{:}}
\fl{ \.{\land}}\al{139}{1}{ Replicas [ r ] . locked}
\fl{ \.{\land}}\al{140}{1}{ m . src \.{=} Replicas [ r ] . logged}
\fl{ \.{\land}}\al{141}{1}{ {\IF} m . apply}
 \fl{ \.{\THEN}}\al{142}{1}{ Replicas \.{'} \.{=} [ Replicas {\EXCEPT} {\bang}
 [ r ] \.{=} [}
 \fl{ locked \.{\mapsto} {\FALSE} ,\, version \.{\mapsto} Replicas [ r ] .
 logged ,\, logged \.{\mapsto}\@w{NULL} ] ]}
 \fl{ \.{\ELSE}}\al{144}{1}{ Replicas \.{'} \.{=} [ Replicas {\EXCEPT} {\bang}
 [ r ] \.{=} [}
 \fl{ locked \.{\mapsto} {\FALSE} ,\, version \.{\mapsto} Replicas [ r ] .
 version ,\, logged \.{\mapsto}\@w{NULL} ] ]}
 \fl{ \.{\land}}\al{146}{1}{ M\_unlock\_resp \.{'} \.{=} M\_unlock\_resp
 \.{\cup} \{ [ src \.{\mapsto} r ,\, tid \.{\mapsto} Replicas [ r ] . logged
 ] \}}
 \fl{ \.{\land}}\al{147}{1}{ {\UNCHANGED} {\langle} M\_read ,\, M\_read\_resp
 ,\, M\_lock ,\, M\_lock\_resp ,\, M\_unlock {\rangle}}
 \fl{ \.{\land}}\al{148}{1}{ {\UNCHANGED} {\langle} Coordinator\_state ,\,
 Coordinator\_txn\_state {\rangle}}
\fl{}
\fl{ CoordinatorAbort ( t ) \.{\defeq}}
\fl{ \.{\land}}\al{151}{1}{ Coordinator\_state [ t ] \.{=}\@w{TryAbort}}
 \fl{ \.{\land}}\al{152}{1}{ \E\,}\al{152}{2}{ k \.{\in} Txns [ t ] \.{:} \A\,
 r \.{\in} Shards [ k ] \.{:}}
 \fl{ \.{\lor}}\al{153}{1}{ \E\, m}\al{153}{3}{ \.{\in}}\al{153}{4}{
 M\_unlock\_resp \.{:} m . src \.{=} r \.{\land} m . tid \.{=} t}
 \fl{ \.{\lor}}\al{154}{1}{ \E\, m}\al{154}{3}{ \.{\in}}\al{154}{4}{
 M\_lock\_resp \.{:} m . src \.{=} r \.{\land} m . dst \.{=} t \.{\land}
 {\lnot} m . locked}
 \fl{ \.{\land}}\al{155}{1}{ Coordinator\_state \.{'} \.{=} [
 Coordinator\_state {\EXCEPT} {\bang} [ t ] \.{=}\@w{Abort} ]}
 \fl{ \.{\land}}\al{156}{1}{ {\UNCHANGED} {\langle} Replicas ,\, Msgs ,\,
 Coordinator\_txn\_state {\rangle}}
\fl{}
\fl{}
\fl{ Next}\al{159}{1}{ \.{\defeq}}
 \fl{ \.{\lor}}\al{160}{1}{ \E\, r}\al{160}{3}{ \.{\in}}\al{160}{4}{
 RIDs}\al{160}{5}{ \.{:}}\al{160}{6}{ \.{\lor}}\al{160}{7}{ ReplicaRead ( r )}
\fl{ \.{\lor}}\al{161}{1}{ ReplicaLock ( r )}
\fl{ \.{\lor}}\al{162}{1}{ ReplicaUnlock ( r )}
 \fl{ \.{\lor}}\al{163}{1}{ \E\, t}\al{163}{3}{ \.{\in}}\al{163}{4}{
 TIDs}\al{163}{5}{ \.{:}}\al{163}{6}{ \.{\lor}}\al{163}{7}{ CoordinatorStart
 ( t )}
\fl{ \.{\lor}}\al{164}{1}{ CoordinatorRead ( t )}
\fl{ \.{\lor}}\al{165}{1}{ CoordinatorLock ( t )}
\fl{ \.{\lor}}\al{166}{1}{ CoordinatorCommit ( t )}
\fl{ \.{\lor}}\al{167}{1}{ CoordinatorStartAbort ( t )}
\fl{ \.{\lor}}\al{168}{1}{ CoordinatorAbort ( t )}
\fl{}
 \fl{ Spec \.{\defeq} Init \.{\land} {\Box} [ Next ]_{ {\langle} Replicas ,\,
 Coordinator\_state ,\, Coordinator\_txn\_state ,\, Msgs {\rangle}}}
\fl{}
\fl{ Serialisability ( C ) \.{\defeq}}
\fl{ \.{\lor}}\al{173}{1}{ Cardinality ( C ) \.{<} 2}
\fl{ \.{\lor}}\al{174}{1}{ \E\, R \.{\in} {\SUBSET} ( C \.{\times} C ) \.{:}}
\fl{}
 \fl{ \.{\land} \A\, t1 \.{\in} C \.{:} {\langle} t1 ,\, t1 {\rangle}
 \.{\notin} R}
\fl{}
 \fl{ \.{\land} \A\, t1 ,\, t2 ,\, t3 \.{\in} C \.{:} ( {\langle} t1 ,\, t2
 {\rangle} \.{\in} R \.{\land} {\langle} t2 ,\, t3 {\rangle} \.{\in} R )
 \.{\implies} {\langle} t1 ,\, t3 {\rangle} \.{\in} R}
\fl{}
\fl{}
\fl{ \.{\land}}\al{181}{1}{ \A\, t1 ,\, t2 \.{\in} C \.{:}}
 \fl{ ( \E\, k \.{\in} Txns [ t2 ] \.{:} Coordinator\_txn\_state [ t2 ] [ k ]
 \.{=} t1 ) \.{\implies} {\langle} t1 ,\, t2 {\rangle} \.{\in} R}
\fl{}
\fl{ \.{\land}}\al{184}{1}{ \A\, t1 ,\, t2 \.{\in} C \.{:}}
 \fl{ ( t1 \.{\neq} t2 \.{\land} Txns [ t1 ] \.{\cap} Txns [ t2 ] \.{\neq} \{
 \} ) \.{\implies} {\langle} t1 ,\, t2 {\rangle} \.{\in} R \.{\lor} {\langle}
 t2 ,\, t1 {\rangle} \.{\in} R}
\fl{}
 \fl{ CommittedTIDs \.{\defeq} \{ t \.{\in} TIDs \.{:} Coordinator\_state [ t
 ] \.{=}\@w{Commit} \}}
\fl{}
\fl{}\bottombar\cl{}
\end{document}
